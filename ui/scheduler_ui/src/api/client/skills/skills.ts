...
export const getListSkillsQueryKey = () => {
    return [
    `${process.env.NEXT_PUBLIC_V1_API_BASE_URL}/skills/`
    ] as const;
    }
 ...
 */
export const createSkill = async (skillCreate: SkillCreate, options?: RequestInit): Promise<createSkillResponse> => {
...
export const getCreateSkillMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createSkill>>, TError,{data: SkillCreate}, TContext>, fetch?: RequestInit}

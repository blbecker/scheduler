...
export const getCreateScheduleSolveMockHandler = (
  overrideResponse?:
    | ScheduleSolveCreateResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<ScheduleSolveCreateResponse> | ScheduleSolveCreateResponse),
...
export const getGetScheduleSolveStatusMockHandler = (
  overrideResponse?:
    | ScheduleSolveStatus
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<ScheduleSolveStatus> | ScheduleSolveStatus),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getGetScheduleSolveResultMockHandler = (
  overrideResponse?:
    | ScheduleSolveResult
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<ScheduleSolveResult> | ScheduleSolveResult),
  options?: RequestHandlerOptions,
) => {
  return http.get(

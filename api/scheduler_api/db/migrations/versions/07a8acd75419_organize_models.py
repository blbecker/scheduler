...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["shift_id"], ["shift.id"], name=op.f("shiftskilllink_shift_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.id"], name=op.f("shiftskilllink_skill_id_fkey")
        ),
    ...
    op.create_table(
        ...
        sa.Column("skill_id", sa.UUID(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["skill_id"], ["skill.id"], name=op.f("workerskilllink_skill_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["worker_id"], ["worker.id"], name=op.f("workerskilllink_worker_id_fkey")
        ),
        sa.PrimaryKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("worker_id", sa.UUID(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["shift_id"], ["shift.id"], name=op.f("shiftworkerlink_shift_id_fkey")
        ),
        sa.ForeignKeyConstraint(
            ["worker_id"], ["worker.id"], name=op.f("shiftworkerlink_worker_id_fkey")
        ),
        sa.PrimaryKeyConstraint(
    ...
    op.drop_index(
        op.f("ix_shift_templates_schedule_template_id"), table_name="shift_templates"
    )

...
from scheduler_api.schemas.shift import Shift, ShiftResponse, ShiftUpdate
...
def from_create(dto: Shift) -> ShiftModel:
    return Shift(**dto.model_dump())


def apply_update(model: ShiftModel, dto: ShiftUpdate) -> Shift:

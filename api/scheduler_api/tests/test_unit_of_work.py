...
class TestUnitOfWork:
    ...
    def test_commit_exception_logs_error_with_stack_trace(
        self, uow, mock_session, caplog
    ):
    ...
    def test_rollback_exception_logs_error_with_stack_trace(
        self, uow, mock_session, caplog
    ):
    ...
    def test_flush_exception_logs_error_with_stack_trace(
        self, uow, mock_session, caplog
    ):
    ...
    def test_refresh_exception_logs_error_with_stack_trace(
        self, uow, mock_session, caplog
    ):

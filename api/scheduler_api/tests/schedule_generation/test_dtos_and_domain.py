...
class TestDTOToDomainConversion:
    ...
    def test_mapper_schedule_layout_conversion(self, sample_schedule_layout_dto):
        ...
        assert (
            domain_layout.date_range_start
            == sample_schedule_layout_dto.date_range_start
        )
        assert domain_layout.date_range_end == sample_schedule_layout_dto.date_range_end
        assert len(domain_layout.worker_ids) == len(
            sample_schedule_layout_dto.worker_ids
        )
        ...
        assert (
            back_to_dto.date_range_start == sample_schedule_layout_dto.date_range_start
        )

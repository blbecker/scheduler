...
class TestShiftTemplateService:
    ...
    def test_list_shift_templates(self, mock_uow, sample_shift_template_model, sample_shift_template_response):
        # Setup
        mock_repo = MagicMock()
    ...
    def test_get_shift_template(self, mock_uow, sample_shift_template_model, sample_shift_template_response):
        # Setup
    ...
    def test_create_shift_template(self, mock_uow, sample_shift_template_model, sample_shift_template_response):
        # Setup
    ...
    def test_update_shift_template(self, mock_uow, sample_shift_template_model, sample_shift_template_response):
        # Setup
        template_id = sample_shift_template_model.id

...
@dataclass
class NoDoubleBookingConstraint(Constraint[ScheduleGenome, ScheduleSolveContext]):
    ...
    def validate(self, genome: ScheduleGenome, context: ScheduleSolveContext) -> bool:
        ...
        for shift_id, assigned_workers in genome.assignments.items():
            ...
            for worker_id in assigned_workers:
                ...
                worker_schedules[worker_id].append((start_time, end_time))
    ...
    def penalty(self, genome: ScheduleGenome, context: ScheduleSolveContext) -> float:

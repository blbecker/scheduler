...
class ScheduleLayoutRepository:
    ...
    def update(self, layout_id: UUID, layout_update: ScheduleLayoutUpdate) -> Optional[ScheduleLayout]:
    ...
    def get_by_date_range(self, start_date: Optional[datetime] = None, end_date: Optional[datetime] = None) -> List[ScheduleLayout]:
